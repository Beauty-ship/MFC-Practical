...
solution_of_the_system_of_equations = np.linalg.solve(coefficients_matrix,column_matrix)
print("solution of the system of equation using gauss elimination method")
